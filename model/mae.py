...
default_cfgs = {
    ...
    'vit_large_patch16_mae': _cfg(
        url='https://dl.fbaipublicfiles.com/mae/finetune/mae_finetuned_vit_large.pth',# https://dl.fbaipublicfiles.com/mae/pretrain/mae_pretrain_vit_large.pth
    ),
...
#     model = vit_base_patch16_mae(pretrained=True)
